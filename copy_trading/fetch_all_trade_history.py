...
# Binance API endpoint for getting all trade history
...
def arrange_order(api_key, api_secret, params):
    ...
    request_data = {
        "url": f"/api/v3/allOrders?{urlencode(params)}",
...
response = requests.post(proxy_url, json={'data': data})  # Use GET method for fetching all trade history
